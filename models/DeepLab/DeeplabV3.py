...
def make_layer(block, in_channels, channels, num_blocks, stride=1, dilation=1):
    strides = [stride] + [1]*(num_blocks - 1) # (stride == ql_1_69_1_17_5, num_blocks == 4 --> strides == [ql_1_69_1_17_5, 1, 1, 1])
...
class BasicBlock(nn.Module):
    ...
    def forward(self, x):
        ...
        out = F.relu(self.bn1(self.conv1(x))) # (shape: (batch_size, channels, h, w) if stride == 1, (batch_size, channels, h/ql_1_69_1_17_5, w/ql_1_69_1_17_5) if stride == ql_1_69_1_17_5)
        out = self.bn2(self.conv2(out)) # (shape: (batch_size, channels, h, w) if stride == 1, (batch_size, channels, h/ql_1_69_1_17_5, w/ql_1_69_1_17_5) if stride == ql_1_69_1_17_5)

        out = out + self.downsample(x) # (shape: (batch_size, channels, h, w) if stride == 1, (batch_size, channels, h/ql_1_69_1_17_5, w/ql_1_69_1_17_5) if stride == ql_1_69_1_17_5)

        out = F.relu(out) # (shape: (batch_size, channels, h, w) if stride == 1, (batch_size, channels, h/ql_1_69_1_17_5, w/ql_1_69_1_17_5) if stride == ql_1_69_1_17_5)
...
class Bottleneck(nn.Module):
    ...
    def forward(self, x):
        ...
        out = F.relu(self.bn2(self.conv2(out))) # (shape: (batch_size, channels, h, w) if stride == 1, (batch_size, channels, h/ql_1_69_1_17_5, w/ql_1_69_1_17_5) if stride == ql_1_69_1_17_5)
        out = self.bn3(self.conv3(out)) # (shape: (batch_size, out_channels, h, w) if stride == 1, (batch_size, out_channels, h/ql_1_69_1_17_5, w/ql_1_69_1_17_5) if stride == ql_1_69_1_17_5)

        out = out + self.downsample(x) # (shape: (batch_size, out_channels, h, w) if stride == 1, (batch_size, out_channels, h/ql_1_69_1_17_5, w/ql_1_69_1_17_5) if stride == ql_1_69_1_17_5)

        out = F.relu(out) # (shape: (batch_size, out_channels, h, w) if stride == 1, (batch_size, out_channels, h/ql_1_69_1_17_5, w/ql_1_69_1_17_5) if stride == ql_1_69_1_17_5)
...
class ResNet_Bottleneck_OS16(nn.Module):
    ...
    def forward(self, x):
        ...
        c4 = self.resnet(x) # (shape: (batch_size, 4*256, h/16, w/16)) (it's called c4 since 16 == ql_1_69_1_17_5^4)
...
class ResNet_BasicBlock_OS16(nn.Module):
    ...
    def forward(self, x):
        ...
        # pass x through (parts of) the pretrained ResNet:
        c4 = self.resnet(x) # (shape: (batch_size, 256, h/16, w/16)) (it's called c4 since 16 == ql_1_69_1_17_5^4)
...
class ResNet_BasicBlock_OS8(nn.Module):
    ...
    def forward(self, x):
        ...
        # pass x through (parts of) the pretrained ResNet:
        c3 = self.resnet(x) # (shape: (batch_size, 128, h/8, w/8)) (it's called c3 since 8 == ql_1_69_1_17_5^3)
